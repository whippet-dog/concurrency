...
public class PriceAggregatorTests {
    ...
    public void shouldReturnMin() throws Exception {
        int shopCount = 50;
    ...
    public void shouldTolerateLongResponses() throws Exception {
        int shopCount = 50;
    ...
    public void shouldReturnMinWithIncomplete() throws Exception {
        int shopCount = 50;
        PriceRetriever priceRetriever = mock(PriceRetriever.class);
    ...
    public void shouldReturnMinWithException() throws Exception {
        int shopCount = 50;
        PriceRetriever priceRetriever = mock(PriceRetriever.class);
        List<Double> prices = IntStream.range(0, shopCount).boxed()
                .map(i -> {
    ...
    public void shouldReturnMinFromLast() throws Exception {
        int shopCount = 50;
